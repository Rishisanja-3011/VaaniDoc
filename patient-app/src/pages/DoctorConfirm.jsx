...
export default function DoctorConfirm() {
  ...
  // ============================================================
  // CONFIRM DOCTOR + CREATE PATIENT SESSION
  // ============================================================

  async function handleContinue() {
    if (!doctorCode || !doctor) {
      return
    }
    ...
    try {
      /*
       * IMPORTANT:
       * The patient joins using the doctor's public code.
       *
       * Example:
       * VAN-M5VMQN
       *
      ...
      setErrorMsg(
        friendlyApiError(err) ?? ERR.SESSION_START
      )
  ...
  return (
    <div style={s.screen}>
            ...
            <>
              ...
              <div style={s.card}>
                ...
                <p style={s.confirmLabel}>
                  You are requesting consultation with:
                </p>
      ...
      <footer style={s.footer}>
        Your information is used only during this
